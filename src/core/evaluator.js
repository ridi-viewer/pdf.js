...
var PartialEvaluator = (function PartialEvaluatorClosure() {
  ...
  NativeImageDecoder.prototype = {
    ...
    decode(image) {
      ...
      return decodePromise.then(function({ data, width, height, }) {
  ...
  NativeImageDecoder.isDecodableByBrowser = function(image, xref, res,
                                                     pdfFunctionFactory) {
    var dict = image.dict;
    if (dict.has('DecodeParms') || dict.has('DP')) {
      return false;
  ...
  PartialEvaluator.prototype = {
    ...
    buildPaintImageXObject({ resources, image, isInline = false, operatorList,
      ...
      if (nativeImageDecoderSupport === NativeImageDecoding.DECODE &&
          (image instanceof JpegStream || image instanceof JpxStream ||
